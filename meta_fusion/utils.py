...
#     """
#     Load all data from the dataloader and convert them to numpy arrays for multiple modalities with heterogeneous dimensions.
    
#     Args:
#         dataloader: A DataLoader object containing the dataset.
        
#     Returns:
#         A tuple containing a list of numpy arrays for each modality and a numpy array for the target variable.
#     """
#     dataset = dataloader.dataset
#     data = dataset.data.numpy()  # Convert entire dataset to a numpy array
#     dim_modalities = dataset.dim_modalities  # Assume this is a list of tuples defining modality shapes
    
#     # Extract modalities based on dimension tuples
#     modalities = []
#     start_idx = 0

#     for dim in dim_modalities:
#         end_idx = start_idx + np.prod(dim)
#         modality_data = data[:, start_idx:end_idx].reshape(-1, *dim)
#         modalities.append(modality_data)
#         start_idx = end_idx
...
#     return modalities, Y.squeeze()  # Squeeze Y to remove any singleton dimensions
