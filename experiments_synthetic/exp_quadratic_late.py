...
ckpt_dir = f"./checkpoints/{exp_name}/{extractor_type}_noise_ratio{noise_ratio}_seed{seed}/"
...
outfile_name = f"{extractor_type}_noise_ratio{noise_ratio}_seed{seed}"
